...
void init_paging()
{
    ...
    /* Identity map the first 512MB (0x0 - 0x20000000) */
    /* This covers the kernel, VGA, Heap, and ELF load addresses */
    uint32_t num_pages = (512 * 1024 * 1024) / 4096;
